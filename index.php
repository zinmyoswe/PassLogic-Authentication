...
<div id="header">
	<div id="titleArea">ZINMYOSWE</div>
</div>
...
<td id="randamNumbarTableLeft">
	...
	<tr>
	<td><div class="randamNumberBoxRadius"><p id="0">0</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="1">1</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="2">2</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="3">3</p></div></td>
	</tr>
	<tr>
	<td><div class="randamNumberBoxRadius"><p id="4">4</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="5" name="5">5</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="6">6</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="7">7</p></div></td>
	</tr>
	<tr>
	<td><div class="randamNumberBoxRadius"><p id="8">8</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="9">9</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="10">10</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="11">11</p></div></td>
	</tr>
	<tr>
	<td><div class="randamNumberBoxRadius"><p id="12">12</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="13">13</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="14">14</p></div></td>
	<td><div class="randamNumberBoxRadius"><p id="15">15</p></div></td>
	</tr>
	</table>
</td>
<td id="randamNumbarTableCenter">
	<table class="randamNumbarWidth">
	<tr>
	<td><div class="randamNumberBoxRadius"><p id="16">16</p></div></td>
...
<div id="softkey" class="clearfix">
	<div class="clearfix">
	<div class="numbar"><div class="keyboardNum"><div class="keyboardNumInner">1</div></div></div>
	<div class="numbar"><div class="keyboardNum"><div class="keyboardNumInner">2</div></div></div>
	<div class="numbar"><div class="keyboardNum"><div class="keyboardNumInner">3</div></div></div>
	<div class="numbar"><div class="keyboardNum"><div class="keyboardNumInner">4</div></div></div>
	<div class="numbar"><div class="keyboardNum"><div class="keyboardNumInner">5</div></div></div>
	</div>
	<div class="clearfix">
	<div class="numbar"><div class="keyboardNum"><div class="keyboardNumInner">6</div></div></div>
	<div class="numbar"><div class="keyboardNum"><div class="keyboardNumInner">7</div></div></div>
	<div class="numbar"><div class="keyboardNum"><div class="keyboardNumInner">8</div></div></div>
	<div class="numbar"><div class="keyboardNum"><div class="keyboardNumInner">9</div></div></div>
	<div class="numbar"><div class="keyboardNum"><div class="keyboardNumInner">0</div></div></div>
	<div class="del"><div class="delBox"><div class="delBoxInner"><i class="fas fa-trash"></i></div></div></div>
	</div>
</div>

<small style="font-size:0.8em">*This demonstration differs slightly from the actual login procedure.</small><br>
<small style="font-size:0.8em">*The password is starred out (********) in the actual login procedure.</small>
...
function login(){
var 
	// var sasa = document.getElementById("name").value;
	passwd = $("p#0").html();
	passwd += $("p#5").html();
	passwd += $("p#10").html();
	passwd += $("p#15").html();
